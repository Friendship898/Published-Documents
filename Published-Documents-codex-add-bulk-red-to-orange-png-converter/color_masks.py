...
def build_semantic_weights(
    ...
    visible_source_glow = source_glow * alpha_w
    visible_highlight_link = highlight_link * alpha_w

    source_pixels = int(np.count_nonzero(visible_source_glow > 0.35))
    highlight_pixels = int(np.count_nonzero(visible_highlight_link > 0.30))
